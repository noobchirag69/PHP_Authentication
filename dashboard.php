...
<body>
	...
	<div tabindex="0" class="welcome">
		...
		<div class="welcome-options">
			<a class="option" href="logout.php" onclick="return confirm('Log out of the current session?');">Logout</a>
			<a class="option" href="change-password.php">Change Password</a>
		</div>
		<div class="table-container">
			<table tabindex="0">
				...
				<tr tabindex="0">
					<td tabindex="0" class="heading">Email</td>
